            ...
            <section className="bg-white border border-gray-100 rounded-2xl p-4 space-y-3">
                ...
                <div>
                    ...
                    <select
                        ...
                        className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm text-black focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all font-medium appearance-none bg-white"
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all font-mono text-black"
                    />
                </div>
            </section>
